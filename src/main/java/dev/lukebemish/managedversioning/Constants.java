...
public final class Constants {
    ...
    public static final class Versions {
        ...
        public static final String WRAPPER_VALIDATION = "gradle/actions/wrapper-validation@v4";
        public static final String DEPENDENCY_SUBMISSION = "gradle/actions/dependency-submission@v4";
        ...
        public static final String GRADLE = "gradle/actions/setup-gradle@v4";
